    ...
    >
      ...
      >
        ...
        <a
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLElement).style.backgroundColor = "#00D4FF";
      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative" style={{ zIndex: 2 }}>
          ...
          <h1
            className="font-extrabold tracking-tighter mb-6 italic uppercase"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-10 py-5 rounded-full font-bold text-xl text-black transition-all transform hover:scale-105"
            style={{
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >
                ...
                />
                <div className="absolute inset-0 flex flex-col items-center justify-end pb-10 opacity-0 group-hover:opacity-100 transition-opacity"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            {[
              ...
              <div key={step} className="space-y-5 group">
                <div
      ...
      >
        <div className="container mx-auto px-6 flex flex-col items-center text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 px-8 py-4 rounded-full font-bold text-lg border transition-all"
